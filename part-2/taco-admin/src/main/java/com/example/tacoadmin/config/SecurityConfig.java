package com.example.tacoadmin.config;

import com.example.tacoadmin.service.IngredientService;
import com.example.tacoadmin.service.RestIngredientService;
...
public class SecurityConfig {
    ...
    public IngredientService ingredientService(OAuth2AuthorizedClientService clientService) {
        ...
        if (authentication.getClass().isAssignableFrom(OAuth2AuthenticationToken.class)) {
            ...
            if (clientId.equals("taco-admin-client")) {
                OAuth2AuthorizedClient client = clientService.loadAuthorizedClient(clientId, oauthToken.getName());

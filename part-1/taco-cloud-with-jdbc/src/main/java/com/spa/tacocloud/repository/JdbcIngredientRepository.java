...
public class JdbcIngredientRepository implements IngredientRepository {
    ...
    public List<Ingredient> findAll() {
        return jdbcTemplate.query("select id, name, type from Ingredient", this::rowToIngredient);
    }

    @Override
    public Optional<Ingredient> findById(String id) {
        List<Ingredient> results = jdbcTemplate.query("select id, name, type from Ingredient where id=?",
                this::rowToIngredient, id);
    ...
    private Ingredient rowToIngredient(ResultSet row, int rowNum) throws SQLException {
